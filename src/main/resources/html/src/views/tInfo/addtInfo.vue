    ...
    handlePictureCardPreview(file) {
      ...
      window.history.go(-1);
        ...
        let para = {
         ...
         if(para.tInfoTitle == null || para.tInfoTitle == ''){
this.$message({
              message: "请添加名称",
              type: "info"
            });
            return;
         }else if(para.tInfoMoney == null || para.tInfoMoney == ''){
this.$message({
              message: "请输入门票",
              type: "info"
            });
            return;
         }else if(para.tInfoIntroduce == null || para.tInfoIntroduce == ''){
this.$message({
              message: "请输入介绍",
              type: "info"
            });
            return;
         }else if(para.tInfoAddress == null || para.tInfoAddress == ''){
this.$message({
              message: "请输入地点",
              type: "info"
            });
